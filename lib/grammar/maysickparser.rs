...
use std::any::Any;
	...
	pub const ruleNames: [&'static str; 20] =  [
		"prog", "stmt", "stmt_let", "stmt_var", "stmt_return", "stmt_import", 
		"stmt_assign", "stmt_fn_def", "fn_call", "expr", "expr_ident", "expr_unary", 
		"expr_mul", "expr_add", "expr_and", "expr_or", "block", "if_expr", "else_stmt", 
		"while_expr"
	];
...
impl Recognizer for MaysickParserExt{
	...
	fn get_grammar_file_name(&self) -> & str{ "Maysick.g4"}
...
impl MaysickParserExt{
	...
	fn expr_mul_sempred(_localctx: &Expr_mulContext, pred_index:isize,
						recog:&mut <Self as Actions>::Recog
		) -> bool {
		match pred_index {
				0=>{
	...
	fn expr_add_sempred(_localctx: &Expr_addContext, pred_index:isize,
						recog:&mut <Self as Actions>::Recog
		) -> bool {
		match pred_index {
				3=>{
	...
	fn expr_and_sempred(_localctx: &Expr_andContext, pred_index:isize,
						recog:&mut <Self as Actions>::Recog
		) -> bool {
		match pred_index {
				5=>{
	...
	fn expr_or_sempred(_localctx: &Expr_orContext, pred_index:isize,
						recog:&mut <Self as Actions>::Recog
		) -> bool {
		match pred_index {
				6=>{
...
impl CustomRuleContext for ProgContextExt{
    ...
    fn enter(ctx:&BaseParserRuleContext<Self>,listener: &mut dyn Any) where Self:Sized {
    	listener.downcast_mut::<Box<dyn MaysickListener> >()
...
fn EOF(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(EOF, 0)
}
fn stmt_all(&self) ->  Vec<Rc<StmtContextAll>> where Self:Sized{
	self.children_of_type()
}
fn stmt(&self, i: usize) -> Option<Rc<StmtContextAll>> where Self:Sized{
...
impl MaysickParser{
	...
	-> Result<Rc<ProgContextAll>,ANTLRError> {
		let mut recog = self;
		...
		let result: Result<(), ANTLRError> = try {
			...
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << IF) | (1usize << WHILE) | (1usize << FN) | (1usize << LET) | (1usize << VAR) | (1usize << RETURN) | (1usize << IMPORT) | (1usize << SYM_LPAREN) | (1usize << SYM_LCURLY) | (1usize << SYM_SUB) | (1usize << IDENT) | (1usize << LIT_STRING) | (1usize << LIT_NUMBER))) != 0) {
				{
				{
				/*InvokeRule stmt*/
...
fn expr(&self) -> Option<Rc<ExprContextAll>> where Self:Sized{
...
fn SYM_SEMICOLON(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(SYM_SEMICOLON, 0)
}
fn stmt_var(&self) -> Option<Rc<Stmt_varContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn stmt_let(&self) -> Option<Rc<Stmt_letContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn stmt_return(&self) -> Option<Rc<Stmt_returnContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn stmt_import(&self) -> Option<Rc<Stmt_importContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn stmt_assign(&self) -> Option<Rc<Stmt_assignContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn stmt_fn_def(&self) -> Option<Rc<Stmt_fn_defContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn block(&self) -> Option<Rc<BlockContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn if_expr(&self) -> Option<Rc<If_exprContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn while_expr(&self) -> Option<Rc<While_exprContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	...
	-> Result<Rc<StmtContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(1,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(SYM_SEMICOLON,recog.err_handler.as_mut())?;
...
fn LET(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn IDENT(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_EQ(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	pub fn stmt_let(&mut self,)
	-> Result<Rc<Stmt_letContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
fn VAR(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	pub fn stmt_var(&mut self,)
	-> Result<Rc<Stmt_varContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl Stmt_returnContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Stmt_returnContextAll> {
		Rc::new(
...
fn RETURN(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	pub fn stmt_return(&mut self,)
	-> Result<Rc<Stmt_returnContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Stmt_returnContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 8, RULE_stmt_return);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << IF) | (1usize << WHILE) | (1usize << SYM_LPAREN) | (1usize << SYM_SUB) | (1usize << IDENT) | (1usize << LIT_STRING) | (1usize << LIT_NUMBER))) != 0) {
				{
				/*InvokeRule expr*/
...
impl Stmt_importContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Stmt_importContextAll> {
		Rc::new(
...
fn IMPORT(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn LIT_STRING(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	pub fn stmt_import(&mut self,)
	-> Result<Rc<Stmt_importContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Stmt_importContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 10, RULE_stmt_import);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(LIT_STRING,recog.err_handler.as_mut())?;
...
impl Stmt_assignContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Stmt_assignContextAll> {
		Rc::new(
...
impl MaysickParser{
	pub fn stmt_assign(&mut self,)
	-> Result<Rc<Stmt_assignContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Stmt_assignContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 12, RULE_stmt_assign);
...
impl Stmt_fn_defContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Stmt_fn_defContextAll> {
		Rc::new(
...
fn FN(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(FN, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token IDENT in current rule
fn IDENT_all(&self) -> Vec<Rc<TerminalNode> >  where Self:Sized{
	self.children_of_type()
}
...
fn IDENT(&self, i: usize) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_LPAREN(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_RPAREN(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	pub fn stmt_fn_def(&mut self,)
	-> Result<Rc<Stmt_fn_defContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Stmt_fn_defContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 14, RULE_stmt_fn_def);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(SYM_LPAREN,recog.err_handler.as_mut())?;
			...
			recog.base.match_token(SYM_RPAREN,recog.err_handler.as_mut())?;
...
fn expr_all(&self) ->  Vec<Rc<ExprContextAll>> where Self:Sized{
	self.children_of_type()
}
fn expr(&self, i: usize) -> Option<Rc<ExprContextAll>> where Self:Sized{
	self.child_of_type(i)
}
...
impl MaysickParser{
	...
	-> Result<Rc<Fn_callContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << IF) | (1usize << WHILE) | (1usize << SYM_LPAREN) | (1usize << SYM_SUB) | (1usize << IDENT) | (1usize << LIT_STRING) | (1usize << LIT_NUMBER))) != 0) {
				{
				{
				/*InvokeRule expr*/
...
fn expr_or(&self) -> Option<Rc<Expr_orContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	...
	-> Result<Rc<ExprContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl Expr_identContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Expr_identContextAll> {
		Rc::new(
...
fn LIT_NUMBER(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn fn_call(&self) -> Option<Rc<Fn_callContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	pub fn expr_ident(&mut self,)
	-> Result<Rc<Expr_identContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Expr_identContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 20, RULE_expr_ident);
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				3 =>{
					...
					recog.base.match_token(LIT_NUMBER,recog.err_handler.as_mut())?;
...
impl Expr_unaryContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Expr_unaryContextAll> {
		Rc::new(
...
fn SYM_SUB(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(SYM_SUB, 0)
}
fn expr_ident(&self) -> Option<Rc<Expr_identContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	pub fn expr_unary(&mut self,)
	-> Result<Rc<Expr_unaryContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Expr_unaryContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 22, RULE_expr_unary);
			...
			match recog.base.input.la(1) {
			 SYM_SUB 
				=> {
					...
					recog.base.match_token(SYM_SUB,recog.err_handler.as_mut())?;
...
fn expr_unary(&self) -> Option<Rc<Expr_unaryContextAll>> where Self:Sized{
	self.child_of_type(0)
}
fn expr_mul(&self) -> Option<Rc<Expr_mulContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
fn SYM_MUL(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_DIV(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_MOD(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	pub fn  expr_mul(&mut self,)
	-> Result<Rc<Expr_mulContextAll>,ANTLRError> {
		self.expr_mul_rec(0)
	}

	fn expr_mul_rec(&mut self, _p: isize)
	-> Result<Rc<Expr_mulContextAll>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = Expr_mulContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 24, RULE_expr_mul, _p);
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(7,&mut recog.base)? {
						1 =>{
							...
							let mut tmp = Expr_mulContextExt::new(_parentctx.clone(), _parentState);
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr_mul);
							_localctx = tmp;
							...
							recog.base.match_token(SYM_MUL,recog.err_handler.as_mut())?;
					...
					,
						2 =>{
							...
							recog.base.match_token(SYM_DIV,recog.err_handler.as_mut())?;
					...
					,
						3 =>{
							...
							recog.base.match_token(SYM_MOD,recog.err_handler.as_mut())?;
...
fn expr_add(&self) -> Option<Rc<Expr_addContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
fn SYM_ADD(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	pub fn  expr_add(&mut self,)
	-> Result<Rc<Expr_addContextAll>,ANTLRError> {
		self.expr_add_rec(0)
	}

	fn expr_add_rec(&mut self, _p: isize)
	-> Result<Rc<Expr_addContextAll>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = Expr_addContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 26, RULE_expr_add, _p);
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(9,&mut recog.base)? {
						1 =>{
							{
							/*recRuleAltStartAction*/
							let mut tmp = Expr_addContextExt::new(_parentctx.clone(), _parentState);
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr_add);
							_localctx = tmp;
							...
							recog.base.match_token(SYM_ADD,recog.err_handler.as_mut())?;
...
fn expr_and(&self) -> Option<Rc<Expr_andContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
fn SYM_AND(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	pub fn  expr_and(&mut self,)
	-> Result<Rc<Expr_andContextAll>,ANTLRError> {
		self.expr_and_rec(0)
	}

	fn expr_and_rec(&mut self, _p: isize)
	-> Result<Rc<Expr_andContextAll>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = Expr_andContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 28, RULE_expr_and, _p);
		...
		let result: Result<(), ANTLRError> = try {
			...
			while { _alt!=2 && _alt!=INVALID_ALT } {
				if _alt==1 {
					...
					{
					/*recRuleAltStartAction*/
					let mut tmp = Expr_andContextExt::new(_parentctx.clone(), _parentState);
					recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr_and);
					_localctx = tmp;
					...
					recog.base.match_token(SYM_AND,recog.err_handler.as_mut())?;
...
fn SYM_OR(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	pub fn  expr_or(&mut self,)
	-> Result<Rc<Expr_orContextAll>,ANTLRError> {
		self.expr_or_rec(0)
	}

	fn expr_or_rec(&mut self, _p: isize)
	-> Result<Rc<Expr_orContextAll>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = Expr_orContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 30, RULE_expr_or, _p);
		...
		let result: Result<(), ANTLRError> = try {
			...
			while { _alt!=2 && _alt!=INVALID_ALT } {
				if _alt==1 {
					...
					{
					/*recRuleAltStartAction*/
					let mut tmp = Expr_orContextExt::new(_parentctx.clone(), _parentState);
					recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr_or);
					_localctx = tmp;
...
fn SYM_LCURLY(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
fn SYM_RCURLY(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	-> Result<Rc<BlockContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(15,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(SYM_LCURLY,recog.err_handler.as_mut())?;
					...
					recog.base.match_token(SYM_RCURLY,recog.err_handler.as_mut())?;
...
fn IF(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(IF, 0)
}
/// Retrieves first TerminalNode corresponding to token SYM_LPAREN
/// Returns `None` if there is no child corresponding to token SYM_LPAREN
...
fn else_stmt(&self) -> Option<Rc<Else_stmtContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	...
	-> Result<Rc<If_exprContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl Else_stmtContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<Else_stmtContextAll> {
		Rc::new(
...
fn ELSE(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
	self.get_token(ELSE, 0)
}
fn stmt(&self) -> Option<Rc<StmtContextAll>> where Self:Sized{
	self.child_of_type(0)
}
...
impl MaysickParser{
	...
	-> Result<Rc<Else_stmtContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl While_exprContextExt{
	fn new(parent: Option<ParserRuleContextType>, invoking_state: isize) -> Rc<While_exprContextAll> {
		Rc::new(
...
fn WHILE(&self) -> Option<Rc<TerminalNode> > where Self:Sized{
...
impl MaysickParser{
	...
	-> Result<Rc<While_exprContextAll>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = While_exprContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 38, RULE_while_expr);
